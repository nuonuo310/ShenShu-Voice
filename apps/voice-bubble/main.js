...
app.innerHTML='<div class="chat-preview"><p class="preview-label">聊天中的语音 · 独立预览</p><div class="message"><span class="sender">SHEN</span><div class="bubble" role="group" aria-label="沈述的语音"><button id="play" type="button" aria-label="播放语音"><span class="glyph"></span></button><div class="wave-area"><div class="wave" id="wave" aria-hidden="true">'+wave+'</div><div class="times"><span id="duration">'+formatTime(voice?.duration||0,false)+'</span></div></div></div><p class="error" id="error" role="status"></p></div><p class="preview-foot">文字保留在聊天正文中，气泡只负责播放。</p></div>';
