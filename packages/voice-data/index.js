...
export const voices=[
{id:'english-001',title:'给糯糯的英文声音 · 第一封',shortTitle:'此刻',date:'2026-09-21',category:'英文',duration:10.056,audioUrl:`${import.meta.env.BASE_URL}audio/first-english.mp3`,body:'My legs, my nose, my back, my toes. My arms, my eyes, my chest, my thighs.',intro:'',introZh:'',outro:'',outroZh:'',captions:[{start:0,end:1.25,text:'My legs.',translation:'我的双腿。'},{start:1.25,end:2.38,text:'My nose.',translation:'我的鼻尖。'},{start:2.38,end:3.5,text:'My back.',translation:'我的后背。'},{start:3.5,end:4.63,text:'My toes.',translation:'我的脚尖。'},{start:4.63,end:5.75,text:'My arms.',translation:'我的手臂。'},{start:5.75,end:6.87,text:'My eyes.',translation:'我的眼睛。'},{start:6.87,end:8,text:'My chest.',translation:'我的胸口。'},{start:8,end:10.2,text:'My thighs.',translation:'我的大腿。'}],tone:1,demo:false},
